            ...
            jQuery.validator
                .addMethod(
                    ...
                    function(value, element) {
                        ...
                        return this.optional(element) || (length.test(value)) && isname;
            ...
            jQuery.validator
                .addMethod(
                    ...
                    function(value, element) {
                        ...
                        return this.optional(element) || (length.test(value) && ispwd);
                    }, "6-20位字母和数字、下划线的组合");
            //全数字验证
            jQuery.validator
                .addMethod(
            ...
            jQuery.validator
                .addMethod(
                    ...
                    function(value, element) {
                        ...
                        var length = /^.{6,30}$/;
                        return this.optional(element) || (tel.test(value)) && (length.test(value));
                    }, "请正确填写您的电子邮箱");
            //中文名字
